    ...
    <div
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            <div class="flex justify-center">
                <img src="https://joinstartup.africa/wp-content/uploads/2023/06/startup-1.png" alt=""
                    srcset="">
            ...
            <div class="mt-16">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    <a href="https://laravel.com/docs"
                        ...
                        <div>
                            <div class="h-16 w-16 bg-red-50 flex items-center justify-center rounded-full">
                                <button onclick="runVideo()">Run Video
                    ...
                    <a href="https://laracasts.com"
                        ...
                        <div>
                            <div class="h-16 w-16 bg-red-50 flex items-center justify-center rounded-full">
                                <button id="show-alert">Show Image Alert</button>
    ...
    <script>
        function sendEmail() {
            ...
            const email = new Email({
                to:{{ Auth::user()->email }} ,
                subject: "SweetAlert Email",
                text: "This is an email sent from SweetAlert."
            });
    ...
    <script>
        document.getElementById("show-alert").addEventListener("click", function() {
            Swal.fire({
                ...
                text: 'This is an image alert with a custom image.',
                ...
                customClass: {
                    image: 'custom-image-class' // You can define your own CSS class for the image
                }
            });
        });
    </script>
